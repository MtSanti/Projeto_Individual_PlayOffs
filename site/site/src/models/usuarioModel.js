...
function dadosGraficoJogador() {
    var instrucao = `select pontosCertos as pontos, Usuario.nome from quiz join Usuario on idUsuario = fkUsuario where descrição = 'QuizJogador';`
    return database.executar(instrucao);
} 
...
function atualizar_rankingGeral() {
    ...
    ON fkUsuario = idUsuario where descrição = 'QuizGeral'
