...
router.get("/atualizar_rankingJogador", function (req, res) {
    usuarioController.atualizar_rankingJogador(req, res);
});
...
router.get("/dadosGraficoJogador", function (req, res) {
    usuarioController.dadosGraficoJogador(req, res);
});
